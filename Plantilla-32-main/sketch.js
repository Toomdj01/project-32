...
for (var i = 0; i < playerArrows.length; i++){
  var playerArrow = playerArrows[i]
  var collision = Matter.SAT.collides(playerArrow.body, computer.body);
...
playerArrows.splice(i,1);
  ...
  for (var i = 0; i <computerArrows.length; i++){
  var computerArrow = computerArrows[i]
  var collision = Matter.SAT.collides(computerArrow.body, player.body)
  if(collision.collided){
